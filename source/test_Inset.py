...
import machine
import observable
import DeviceModules.TrafoModule
import CommonModules.AmpAttModule
import CommonModules.AdcModule
import mpmath
...
dict_beam = beam.staticbeam(**dictionary_beam) # dict_beam is a beam object
...
trafo_system_one = special_trafo.combine_systems(trafo_amp,trafo_adc) #  This function combines sensor with its accesories for full DA system
trafo_system_two = special_trafo_2nd.combine_systems(trafo_amp,trafo_adc)
