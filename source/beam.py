...
class dynamicbeam():
    ...
    def phase_space_init(self):
        """ defines the initial 6D phase space of the beam"""
        xpos = np.random.normal(self.parameters['x_dist'][0],self.parameters['x_dist'][1],self.parameters["par_num"])
        xder = np.random.normal(self.parameters['x_dist'][2],self.parameters['x_dist'][3],self.parameters["par_num"])
        ypos = np.random.normal(self.parameters['y_dist'][0],self.parameters['y_dist'][1],self.parameters["par_num"])
        yder = np.random.normal(self.parameters['y_dist'][2],self.parameters['y_dist'][3],self.parameters["par_num"])
        zpos = np.random.normal(self.parameters['z_dist'][0],self.parameters['z_dist'][1],self.parameters["par_num"])
        mom = np.random.normal(self.parameters['z_dist'][2],self.parameters['z_dist'][3],self.parameters["par_num"])
        
        count, bins, ignored = plt.hist(xpos, 30, normed=True)
