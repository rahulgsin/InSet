...
class genericTF():
    ...
    def NGspice(self):
        ...
        self.line1 = [line.split() for line in open('plot0.data',"r")]
        ...
        self.line2 = [line.split() for line in open('plot1.data',"r")]
        ...
        os.remove("Terminal_imp.txt")
        os.remove("Input_signal.txt")
        os.remove("freq_analysis.txt")
...
if __name__ == "__main__":
    dict_tf = {'Schematic':'transfunc.cir', 'Freq_range':'1 1000MEG','Terminal_imp':None,'Input_signal':None, 'Voltage_nodes':['mag(v(2))', 'phase(v(2))']}
